...
//    }
//    if (cancella_riga(scontrino->head, cerca(scontrino->head, 9)))
//        cout << "Riga cancellata." << endl;
//    else
//        cout << "La lista non e' stata toccata" << endl;
    while(cancella_riga(scontrino->head, scontrino->head));
